...
This is covered by the posterior predictive distribution p(y|x,)=∫p(y|x,w)p(w|)dw
 in which the parameters have been marginalized out. This is equivalent to averaging predictions from an ensemble of neural networks weighted by the posterior probabilities of their parameters w
.
