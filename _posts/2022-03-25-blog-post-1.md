...
<div align = 'center'>
<img src='/images/Bayeisan_Fomular.png' width = "500" >
</div>
...
<div align = 'center'>
<img src='/images/Bayeisan_Fomular2.png' width = "500" >
</div>
...
<div align = 'center'>
<img src='/images/Bayeisan_Fomular3.png' width = "500" >
</div>

-logp(x|θ) is Negative Log Likelihood(NLL). Therefore, compared with MLE, MAP is an additional a priori term p(θ) during optimization. In some cases, −logp(θ) can be used as a regularizer in structured risk when using MLE, such as when the prior is a Gaussian distribution:

<div align = 'center'>
<img src='/images/Bayeisan_Fomular4.png' width = "500" >
</div>
